...
//親クラスの他に基底（きてい）クラスと呼んだり、スーパークラスと呼んだりする場合がある
...
class Product extends BaseProduct{
    ...
    public function getProduct(){ //publicは外からもアクセスできるように記述し形にしている //finalをつけるとこのクラスからは継承できない
        parent:: //名前が被っていて親のクラスの関数を使いたい場合に記述するキーワード
        echo $this->product;
    }
